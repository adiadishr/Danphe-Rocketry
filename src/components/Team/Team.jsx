...
const Team = () => {
    return (
            <div className='flex flex-col gap-[6rem] my-[12rem] px-[5%] bg-gradient-to-b from-black via-slate-900 to-black'>
                <div className="flex md:flex-row md:justify-between justify-center items-center gap-[4rem] md:gap-0 flex-col">
