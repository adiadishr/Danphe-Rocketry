    ...
    return (
        <div id='join' data-aos='fade' data-aos-duration="1500" data-aos-once="true" className='h-max flex px-[5%] flex-col overflow-hidden border-b-4 border-double pb-10'>
            <div className='flex w-full justify-center text-white rounded-xl py-10 mb-10 md:mb-0 mt-[60px]'>
                <h1 data-aos='fade-up' data-aos-duration="700" data-aos-once="true" className="text-[calc(1.75rem+2vw)] font-extralight tracking-tight text-white uppercase">
            ...
            <div className="flex flex-col md:flex-row w-full h-full gap-10 md:gap-0">
                <div className="flex h-full md:w-1/2">
                    <img data-aos='zoom-out' data-aos-duration="700" data-aos-once="true" src={astronautImg} className='mt-[-50px] flex w-full brightness-[.7] animate-hover' alt="an astronaut skating" />
                </div>
                <div className="flex h-full md:w-1/2 flex-col gap-6 divide-y">
                    <div className="flex w-full">
                        <p id='join-contetn' data-aos='fade-up' data-aos-duration="700" data-aos-once="true" className='text-white font-light text-justify'>Whether you're an aspiring aerospace engineer, a space enthusiast, or a supporter of scientific advancement, we invite you to join us on our journey to the stars.</p>
                    </div>
                    <div id='socials' data-aos='fade-up' data-aos-duration="700" data-aos-once="true" className="flex w-full pt-6 text-white text-[calc(1rem+1.25vw)] items-center justify-evenly">
                    ...
                    <div data-aos='fade-up' data-aos-duration="700" data-aos-once="true" className="flex w-full pt-4 flex-col">
                        ...
                        <form id='joinForm' className="flex w-full flex-col" autoComplete='false'>
                            ...
                            <div className="flex w-full mt-8">
                                <button className='bg-white px-3 py-2 rounded-3xl transform hover:-translate-y-2 transition-all duration-300 opacity-90 hover:opacity-100'>Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
