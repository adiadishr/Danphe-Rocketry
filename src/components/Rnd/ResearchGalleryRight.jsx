...
const ResearchGalleryRight = ({ title, desc, imgId }) => {
    return (
        <div data-aos='fade-left' data-aos-duration='800' className='flex flex-col md:flex-row border-collapse md:justify-between items-center h-full border-b-2 border-red-600 overflow-x-hidden'>
