...
const ResearchGalleryLeft = ({title, desc, imgId, delay}) => {
    return (
        <div data-aos='fade-right' data-aos-duration='800' data-aos-delay={delay} className='flex flex-col md:flex-row border-collapse md:justify-between items-center h-full border-y-2 border-red-700 '>
